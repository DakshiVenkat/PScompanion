...
$dis_name = read-host -Prompt "Enter the Displayname Property Value`n`t1.Starts with :: Keyword*`n`t2.Ends with :: *Keyword`n`t3.Contains :: *Keyword*`n`t4.Exact :: Keyword`n$("-"*40)`nEnter Input for DisplayName Property Value::"
...
#Loading the Result in to the Variable(Assigmnment)
...
{
clear-host
write-host "Selected Option is Get-Evetnlog`n$("*"*40)" -f yellow
...
$dir_name = read-host -Prompt "Entery the Directory/Folder Size" #D:\PS
